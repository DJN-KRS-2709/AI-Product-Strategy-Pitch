...
- [ ] **5 AI Value Archetypes:** Need all five named and defined. Only "Automator" exists via Klarna. Propose the remaining four.
- [ ] **Prototype Bet logistics:** Pre-work requirements for AI tool accounts (v0/Cursor/Lovable). Minimum viable output definition. Time allocation in M1.
